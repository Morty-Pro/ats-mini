...
2. (BUILD directory, run this command in CMD) you can run the Arduino-CLI to compile and Upload to board, open the repo file and run command (change the COM_PORT to yours, like COM9)
